...
export default function CasamentoPage() {
	return (
		<main className="">
            <p className="text-xl p-4">Bem vindo!</p>
            <p className="p-4">
                Aqui contamos um pouquinho dessa história que todos acompanharam, mas que podem não ter visto por inteiro.
            </p>
            <p className="p-4">
                Por muitos anos estudamos na mesma escola, mas em séries diferentes. Nos víamos nos corredores...
            </p>
